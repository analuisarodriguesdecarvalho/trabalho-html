...
// Obter informações de um usuário específico para o perfil (por enquanto o primeiro usuário)
// Em um sistema real, isso seria do usuário logado da sessão
$usuarioPerfil = !empty($usuarios) ? $usuarios[0] : null;
$seguidores = $usuarioPerfil ? $usuarioDAO->contarSeguidores($usuarioPerfil['id']) : 0;
$seguindo = $usuarioPerfil ? $usuarioDAO->contarSeguindo($usuarioPerfil['id']) : 0;
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
        ...
        <section class="perfil-section">
            <div class="perfil-header">
                ...
                <div class="perfil-info">
                    ...
                    <p class="perfil-email"><?php echo htmlspecialchars($usuarioPerfil['email'], ENT_QUOTES, 'UTF-8'); ?></p>
